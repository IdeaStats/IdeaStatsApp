...
import {
  PlasmicGenericButton,
  DefaultGenericButtonProps
} from "./plasmic/idea_stats_v_1/PlasmicGenericButton";
...
// Omit to hide them:
//
// interface GenericButtonProps extends Omit<DefaultGenericButtonProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
...
function GenericButton_(
  ...
  // fetch data.
  //
  // Props you can pass into PlasmicGenericButton are:
