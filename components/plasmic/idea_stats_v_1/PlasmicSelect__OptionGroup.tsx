...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: wxpOTScsLgX/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: AoV4HBbmR-X/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__jsHwz)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__imxl)}
              />
            </React.Fragment>
          ),
          value: args.children
