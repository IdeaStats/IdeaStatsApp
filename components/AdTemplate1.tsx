...
import {
  PlasmicAdTemplate1,
  DefaultAdTemplate1Props
} from "./plasmic/idea_stats_v_1/PlasmicAdTemplate1";
...
// Omit to hide them:
//
// interface AdTemplate1Props extends Omit<DefaultAdTemplate1Props, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
...
function AdTemplate1_({title, body, buttonText, ...props}: AdTemplate1Props, ref: HTMLElementRefOf<"button">) {
  ...
  // fetch data.
  //
  // Props you can pass into PlasmicAdTemplate1 are:
  ...
  return <PlasmicAdTemplate1 
    root={{ ref }} children={<text>"Hello World"</text>} style ={{
